import { UMLClass, UMLDiagramAST } from '../types/uml';
import { DiagnosticSeverity, UmlDiagnostic, UmlValidationReport } from '../types/validation';

export type { DiagnosticSeverity, UmlDiagnostic, UmlValidationReport };
 ...
 * Ejecución isomórfica instantánea en frontend y backend.
 */
